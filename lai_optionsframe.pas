...
procedure TLAIOptionsFrame.btnDetectModelsClick(Sender: TObject);
var
...
procedure TLAIOptionsFrame.LoadSettings;
begin
  edtURL.Text := LAIConfig.ServerURL;
  cbModel.Text := LAIConfig.ModelName;
end;

procedure TLAIOptionsFrame.SaveSettings;
begin
